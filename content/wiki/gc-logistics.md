...
<!-- date: 2025.10 -->
<!-- summary: 麦克纳姆轮底盘、STM32 角度环、树莓派 4B、ESP32 无线发车 -->
...
[图] FIG.01 · 省赛决赛场地入口，陕西赛区竞赛。（`open gc-3` 看图）
...
[图] FIG.02 · 原型机。前伸舵机爪 + 前置相机 + 双侧料盒。（`open gc-2` 看图）
...
[图] FIG.03 · 省赛夹取实况。转盘供料，车在盘沿作业。（`open gc-1` 看图）
