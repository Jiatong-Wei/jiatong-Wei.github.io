...
// ansi_regular — solid ██ blocks, sharp corners (crisp W middle, solid-A crossbar),
// no ═╔╗ double-line mush, no # or slashes.
const ART_FULL = [
  '     ██ ██  █████  ████████  ██████  ███    ██  ██████      ██     ██ ███████ ██',
  '     ██ ██ ██   ██    ██    ██    ██ ████   ██ ██           ██     ██ ██      ██',
  '     ██ ██ ███████    ██    ██    ██ ██ ██  ██ ██   ███     ██  █  ██ █████   ██',
...
export function profileScreen(cols: number): string[] {
  const art = cols >= 83 ? ART_FULL : cols >= 58 ? ART_STACKED : ART_SMALL;
  const lines: string[] = [''];
  lines.push(
