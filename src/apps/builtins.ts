...
// ansi_shadow glyphs joined per-letter (gap 2/1), programmatically regenerated so every
// row of a block is the same width. W is hand-drawn per user spec: full-height outer
// strokes flush at col 0 (rows 1-5), center peak, two feet centered on row 6.
const ART_FULL = [
  '     ██╗  ██╗   █████╗   ████████╗   ██████╗   ███╗   ██╗   ██████╗   ██      ██  ███████╗  ██╗',
  '     ██║  ██║  ██╔══██╗  ╚══██╔══╝  ██╔═══██╗  ████╗  ██║  ██╔════╝   ██  ██  ██  ██╔════╝  ██║',
  '     ██║  ██║  ███████║     ██║     ██║   ██║  ██╔██╗ ██║  ██║  ███╗  ██  ██  ██  █████╗    ██║',
